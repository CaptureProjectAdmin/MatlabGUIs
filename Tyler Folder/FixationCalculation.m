function events = FixationCalculation(t, xPix, yPix, fs, pxPerDeg)
% Method used IVT
...
params.minFix_s     = 1;   % min fixation duration (s); common 60-100 ms
params.minSac_s     = 0.010;  % min saccade duration (s); common 10 ms
params.smooth_win_s = 0.010;  % smoothing window (s); common 5-15 ms
